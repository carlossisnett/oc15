...
<div class="card card-outline card-info">
	<div class="card-header">
		...
		<h3 class="card-title" id="title"> Nueva Cotización de Compra </h3>
	</div>
	<div class="card-body">
		...
		<form action="" id="po-form">
			...
			<table class="table table-striped table-bordered" id="item-list">
						...
						<tbody>
							...
							<tr class="po-item" data-id="">
								...
								<td class="align-middle p-1">
									<input type="number" step="any" min="0.01" class="text-right w-100 border-0" name="unit_price[]"  value="<?php echo ($row['unit_price']) ?>" disabled/>
								</td>
						...
						<tfoot>
							<tr class="bg-lightblue">
								<tr>
									<th class="p-1 text-right" colspan="8"><span><button class="btn btn btn-sm btn-flat btn-primary py-0 mx-1" type="button" id="add_row">Agregar Fila</button></span></th>
								...
								<tr>
									...
									<input type="number" step="any" name="discount_percentage" class="border-light text-right" value="<?php echo isset($discount_percentage) ? $discount_percentage : null ?>" hidden>
									</th>
									<th class="p-1"><input type="text" class="w-100 border-0 text-right" value="<?php echo isset($discount_amount) ? $discount_amount : null ?>" name="discount_amount" hidden></th>
								</tr>
								<tr>
									<th class="p-1 text-right" colspan="8">
        							...
        							value="<?php echo isset($tax_percentage) && $tax_percentage != 0 ? $tax_percentage : '' ?>" hidden>
									</th>
								...
								<tr>
									<th class="p-1 text-right" colspan="8"></th>
			...
			<div class="row">
				...
				<label for="ruta_adjunto" class="control-label">
								Si quiere, puede Adjuntar archivos (Solo PDF):
							</label>
                <?php
				$number_of_files = 1;
...
<input type="hidden" name="order_item_id[]" value="">
								...
								<td class="align-middle p-1">
									<input type="number" step="any" min="0.01" class="text-right w-100 border-0" name="unit_price[]" disabled>
								</td>
