...
function enviar_email_solicitud_inventario_2($id, $numero_sap){
        ...
        $data = ['servername' => 'oc15-server.mysql.database.azure.com',
        'username' => 'rbbujxqjsz',
        'password' => 'Sandia12...',
        ...
        mysqli_real_connect($conn, $data['servername'], $data['username'], $data['password'], $data['dbname'], 3306, NULL, MYSQLI_CLIENT_SSL);
