...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Duplicar solicitud orden de compra": "Nueva solicitud de compra" ?> </h3>
	</div>
	<div class="card-body">
		<form action="" id="po-form">
			...
			<div class="row">
				<div class="col-md-6 form-group">
					...
					<input type="text" class="form-control form-control-sm rounded-0" id="po_no" name="po_no" value="<?php echo isset($po_no) ? '' : '' ?>" disabled>
						...
						<tbody>
							...
							<tr class="po-item" data-id="">
								...
								<td class="align-middle p-1">
									...
									<input type="text" class="text-left w-100 border-0 item_id" value="<?php echo $row['nombre_item'] ?>" required/>
								</td>
								...
								<td class="align-middle p-1">
									...
									<input type="text" class="text-left w-100 border-0 marca_id" value="<?php echo $row['nombre_marca'] ?>" required/>
								</td>
								<!--Campo oculto item_id-->
								<td class="align-middle p-1">
									<input type="hidden" name="departamento_id[]" value="<?php echo $row['codigo_departamento'] ?>">
									<input type="text" class="text-left w-100 border-0 departamento_id" value="<?php echo $row['nombre_departamento'] ?>" required/>
								</td>
								<td class="align-middle p-1">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<select name="status" id="status" class="form-control form-control-sm rounded-0">
								<option value="0" <?php echo isset($status) && $status == 0 ? '': '' ?>>Pendiente</option>
								<option value="1" <?php echo isset($status) && $status == 1 ? '': '' ?>>Aprobado</option>
								<option value="2" <?php echo isset($status) && $status == 2 ? '': '' ?>>Negado</option>
							</select>
						</div>
						<div class="col-md-6 form-group">
